...
import { CountryRepository } from '../../data/1/CountryRepository'
import { CountryEntity } from '../../data/1/CountryEntity'

const validationModules = await Extensions.loadExtensionModules('codbex-sample-csvim-1-Country', ['validate']);
...
class CountryController {
    ...
    public create(entity: CountryEntity): CountryEntity {
        try {
            ...
            response.setHeader('Content-Location', '/services/ts/codbex-sample-csvim/gen/sample/api/1/CountryController.ts/' + entity.Id);
