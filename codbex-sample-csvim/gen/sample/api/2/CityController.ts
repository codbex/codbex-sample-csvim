...
import { CityRepository } from '../../data/2/CityRepository'
import { CityEntity } from '../../data/2/CityEntity'

const validationModules = await Extensions.loadExtensionModules('codbex-sample-csvim-2-City', ['validate']);

@Controller
@Documentation('codbex-sample-csvim - City Controller')
@Injected()
class CityController {
    ...
    public create(entity: CityEntity): CityEntity {
        try {
            ...
            response.setHeader('Content-Location', '/services/ts/codbex-sample-csvim/gen/sample/api/2/CityController.ts/' + entity.Id);
